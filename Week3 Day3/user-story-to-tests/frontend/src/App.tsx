      ...
      <div className="container">
        ...
        <form onSubmit={handleSubmit} className="form-container">
          <div className="form-group">
            <label htmlFor="jiraStory" className="form-label">
            ...
            <div style={{ display: 'flex', gap: '12px', alignItems: 'center', marginBottom: 8 }}>
              <input
                ...
                placeholder="Enter Jira issue key or URL..."
                autoComplete="off"
                value={jiraInput}
            ...
            <div style={{ minHeight: 22 }}>
              ...
              {!jiraError && !jiraSuccess && (
                <span style={{ color: '#888', fontSize: 13 }}>Enter a Jira issue key (e.g., ABC-123) or full URL and click Fetch.</span>
              )}
            </div>
          </div>
          <div className="form-group">
          ...
          <div className="form-group">
            ...
            <div className="form-group">
              ...
              <div style={{ fontSize: '13px', color: '#888', marginBottom: 8 }}>
                Select one or more categories to generate tests for:
              </div>
                ...
                {[
                  ...
                  <label
                    ...
                    style={{
                      ...
                      gap: '8px',
                      fontWeight: 500,
                      background: formData.testCategory.includes(option.label) ? option.color + '22' : '#f8f9fa',
                      border: `2px solid ${formData.testCategory.includes(option.label) ? option.color : '#e1e8ed'}`,
                      borderRadius: 6,
                      padding: '8px 14px',
                      cursor: 'pointer',
                      transition: 'background 0.2s, border 0.2s',
                      color: formData.testCategory.includes(option.label) ? option.color : '#2c3e50',
                      boxShadow: formData.testCategory.includes(option.label) ? '0 2px 8px 0 #0001' : 'none'
                    }}
                  >
                    <input
                      type="checkbox"
                      value={option.label}
                      checked={formData.testCategory.includes(option.label)}
                      onChange={() => handleCategoryChange(option.label)}
                      style={{ accentColor: option.color, width: 18, height: 18 }}
                    />
